...
export class Plugboard {
    constructor(pairs) {
        ...
        pairs.forEach(pair => {
            ...
            this.input = this.input.slice(0, index_of_input_letter) + output_letter + this.input.slice(index_of_input_letter + 1);
            this.input = this.input.slice(0, index_of_output_letter) + input_letter + this.input.slice(index_of_output_letter + 1);
        });
    }
